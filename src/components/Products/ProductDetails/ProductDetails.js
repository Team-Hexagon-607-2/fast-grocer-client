...
const ProductDetails = () => {
  ...
  return (
    <div className='w-10/12 mx-auto my-20'>
      <div className='flex flex-col md:flex-row items-center mb-10'>
        ...
        <div className='w-full'>
          ...
          <div className='flex items-end'>
            ...
            <p className='text-red-400 font-bold mx-1'><del>{original_price}</del></p>
            {save.length > 0 && <p><small>(Save: {save})</small></p>}
          </div>
          <div className='flex mt-5'>
            <button className='px-3 mr-2 bg-[#9acd5e] hover:bg-[#80b248] duration-300 py-1 rounded-md flex items-center justify-center'><TbShoppingCartPlus className=' mr-2' />Add to Cart</button>
      ...
      {
        description.length > 0 && <div>
        <p className='text-[#7d9734] border-b-2 border-[#7d9734] inline-block text-xl font-semibold mb-3 pb-2'>Description</p>
        <p>{description}</p>
      </div>
      }
    </div>
