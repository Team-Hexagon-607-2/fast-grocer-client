...
const PrivacyPolicy = () => {
    return (
        <div>
            ...
            <h3 className='font-bold text-2xl'>Data We Collect</h3>
            <ol className='list-decimal list-inside'>
            ...
            <br></br>
            <h3 className='font-bold text-2xl'>If you are a Buyer we collect the following data:</h3>
            <ol className='list-decimal list-inside'>
                ...
                <li>
                    Marketing and communications data, such as your preferences in receiving marketing from us and our third parties, your communication preferences and your chat, email or call history on the Site or with third party customer service provider
                </li>
                <li>
            ...
            <h3 className='font-bold text-2xl'>Your Right</h3>
            <ol>
                <li>
            ...
            <h3 className='font-bold text-2xl'>Minors</h3>
            <ol className='list-decimal list-inside'>
                <li>
                ...
                <li>
                If you allow a minor to access the Site and buy products from the Site by using your account, you hereby consent to the processing of the minors' personal data and accept and agree to be bound by this Privacy Policy and take responsibility for his or her actions
                </li>
                <li>
