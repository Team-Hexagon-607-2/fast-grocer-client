...
const Cart = () => {
  ...
  return (
    <div className={isAdmin || isDeliveryman ? "dropdown dropdown-end hidden" : "dropdown dropdown-end"}>
      <label onClick={() => setToggle(!toggle)} tabIndex={0} className="btn btn-ghost btn-circle">
      ...
      <div tabIndex={0}
        className={toggle ?
          "hidden mt-3 card card-compact dropdown-content w-52 bg-base-100 shadow" :
          "mt-3 card card-compact dropdown-content rounded-md w-52 bg-base-100 shadow"
        }>
