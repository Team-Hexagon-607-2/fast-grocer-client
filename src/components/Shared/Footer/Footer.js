...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content place-content-center md:place-content-between">
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 place-content-center md:place-content-start">
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 place-content-center md:place-content-between">
                ...
                {/*section for socila links with icons starts*/}
